...
class _RecentBatchCard extends StatelessWidget {
  const _RecentBatchCard({required this.batch});

  final BatchActivity batch;
        ...
        builder: (BuildContext context, BoxConstraints constraints) {
          ...
          final Widget summary = Column(
            ...
            children: <Widget>[
              Wrap(
                ...
                children: <Widget>[
                  Text(batch.id, style: Theme.of(context).textTheme.titleMedium),
                  StatusChip(
                    label: style.label,
                    color: style.color,
          ...
          final Widget progress = Column(
            ...
            children: <Widget>[
              ...
              const SizedBox(height: 8),
              ProgressLine(value: batch.completion / 100, color: style.color),
            ],
          );
            ...
            return Column(
              ...
              children: <Widget>[
                ...
                Wrap(
                  ...
                  runSpacing: 12,
                  children: <Widget>[
                    MiniLabel(label: 'Images', value: '${batch.images}'),
                    MiniLabel(label: 'ETA', value: batch.eta),
                  ],
                ),
                const SizedBox(height: 14),
                progress,
          ...
          return Row(
            children: <Widget>[
              ...
              Expanded(
                flex: 2,
                child: MiniLabel(label: 'Images', value: '${batch.images}'),
              ),
              Expanded(flex: 3, child: MiniLabel(label: 'ETA', value: batch.eta)),
